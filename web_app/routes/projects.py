...
async def get_projects(
    ...
    stmt = stmt.options(
        ...
        selectinload(Projects.project_executors).selectinload(ProjectExecutors.user_info),
        selectinload(Projects.project_executors).selectinload(ProjectExecutors.project_info),
