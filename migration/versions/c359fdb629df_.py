...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_form_of_ownership_id"), "form_of_ownership", ["id"], unique=False
    )
    op.create_table(
        "logs",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_ui_preferences_id"), "user_ui_preferences", ["id"], unique=False
    )
    op.create_table(
        "contacts",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_project_executors_id"), "project_executors", ["id"], unique=False
    )
