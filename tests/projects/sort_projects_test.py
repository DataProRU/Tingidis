...
@pytest.mark.asyncio
async def test_sort_users_by_object_desc(client, sample_project, another_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_number_asc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_number_desc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_deadline_asc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_deadline_desc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_status_asc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_status_desc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_contract_asc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_contract_desc(client, sample_project, another_project, third_project):
    """
...
@pytest.mark.asyncio
async def test_sort_projects_by_main_executor_asc(client, another_project, sample_project, third_project):
    """
    Тест сортировки проектов по исполнителю (main_executor) в порядке возрастания.
    """
    response = client.get("/projects", params={"sortBy": "main_executor", "sortDir": "asc"})
    assert response.status_code == 200
...
@pytest.mark.asyncio
async def test_sort_projects_by_main_executor_desc(client, another_project, sample_project, third_project):
    """
    Тест сортировки проектов по исполнителю (main_executor) в порядке убывания.
    """
    response = client.get("/projects", params={"sortBy": "main_executor", "sortDir": "desc"})
    assert response.status_code == 200
...
async def test_sort_projects_by_invalid_field(client):
    ...
    """
    response = client.get("/projects", params={"sortBy": "invalid_field", "sortDir": "asc"})
