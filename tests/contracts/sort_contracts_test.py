...
async def test_sort_contracts_by_sign_date_asc(
    ...
    agreements = response.json()
    assert (
        agreements[0]["sign_date"] == date(2024,1,1).isoformat()
    )
    assert (
        agreements[1]["sign_date"] == date(2024,2,2).isoformat()
    )
    assert (
        agreements[2]["sign_date"] == date(2024,3,3).isoformat()
    )
...
async def test_sort_contracts_by_sign_date_desc(
    ...
    agreements = response.json()
    assert (
        agreements[0]["sign_date"] == date(2024,3,3).isoformat()
    )
    assert (
        agreements[1]["sign_date"] == date(2024,2,2).isoformat()
    )
    assert (
        agreements[2]["sign_date"] == date(2024,1,1).isoformat()
    )
...
async def test_sort_contracts_by_theme_asc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "theme", "sortDir": "asc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_theme_desc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "theme", "sortDir": "desc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_code_asc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "code", "sortDir": "asc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_code_desc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "code", "sortDir": "desc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_number_asc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "number", "sortDir": "asc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_number_desc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "number", "sortDir": "desc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_customer_asc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "customer", "sortDir": "asc"}
    )
    assert response.status_code == 200
...
async def test_sort_contracts_by_executor_asc(
    ...
    """
    response = client.get(
        "/contracts", params={"sortBy": "executor", "sortDir": "asc"}
    )
    assert response.status_code == 200
